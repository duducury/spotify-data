...
def show_page():
    ...
    # Analysis
    st.write("## Analysis:")
    st.write("The data reveals interesting patterns in streaming numbers surrounding the COVID-19 pandemic. Prior to the onset of COVID-19, there was a gradual decline in streaming numbers, aligning with Spotify increasing their cost of subscription. However, this trend abruptly changed with the emergence of the pandemic.")
